...
def munge_tag(tag):
#    log.debug('ttttttttaaaaaaggggggg')
#    log.debug(tag)
...
class HarvesterBase(SingletonPlugin):
    ...
    def _gen_new_name(self, title):
        ...
        log.debug('_gen_new_name %s' % title )
    ...
    def _create_harvest_objects(self, remote_ids, harvest_job):
        ...
        '''
        log.debug('_create_harvest_objects')
        try:
            object_ids = []
            if len(remote_ids):
